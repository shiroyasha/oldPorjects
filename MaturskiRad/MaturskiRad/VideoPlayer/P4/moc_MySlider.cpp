...
**
** Created: Fri Mar 12 19:15:31 2010
...
static const char qt_meta_stringdata_MySlider[] = {
    "MySlider\0\0positionChanged(int)\0"
};
...
int MySlider::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: positionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
...
// SIGNAL 0
void MySlider::positionChanged(int _t1)
{
