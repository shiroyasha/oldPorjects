...
public class MainServer  extends UnicastRemoteObject implements MessageServerI,AgentServerI{
	...
	*/
	...
	{
		System.out.println("agent "+rpi.getIndexOfAgent()+" se nalazi na serveru "+rpi.getServerInfo().host+":"+rpi.getServerInfo().port+" zavrsio ? "+rpi.finished()+" time "+System.currentTimeMillis());
