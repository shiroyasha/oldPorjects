...
public class Starter {
	...
	private void initialize() 
	{
		...
		do
		{
			try 
			{ 
				String pp = JOptionPane.showInputDialog("Matrix dimension( 5 - 20 )");
				if( pp == null ) System.exit(0);
				dim = Integer.parseInt(pp);
		...
		do
		{
			try 
			{ 
				String pp = JOptionPane.showInputDialog("Wall density( 5 - 50 )");
				if( pp == null ) System.exit(0);
				dens = Integer.parseInt(pp);
		...
		frmMazeSolver.setSize(dim * 50, dim * 50);
