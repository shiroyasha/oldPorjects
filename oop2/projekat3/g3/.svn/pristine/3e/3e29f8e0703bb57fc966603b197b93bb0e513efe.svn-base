 ...
 * @version 10
 *
 * Apstraktna klasa koja omogucava pravljenje novih stranica,
 * ima implementirane neke metode, dok je na svakoj novoj
 * stranici (klasi) potrebno implementirati metod 'defineElements'.
 * 
 * Na stranicama se izvrsava automatsko stilizovanje iz CSS-a.
 *
 */
public abstract class AbstractPage {
	...
	public void logOut() {
		System.out.println("zeleo bi pi*ko da se izlogujes :DDD");
		/*
		if (loggedIn() != null) {
