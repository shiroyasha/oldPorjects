...
class CompletionWindow(gtk.Window):
    ...
    def __init__(self, parent, callback1, up):
        ...
        self.complete_callback = callback1
	...
	print "init tree view"
	print self.view
	print self.view.get_selection()
